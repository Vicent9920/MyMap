...
public class GPSNaviActivity extends AppCompatActivity implements AMapNaviListener,AMapNaviViewListener {
...
//        mAMapNavi.addAMapNaviListener(mTtsManager);
        ...
        NaviLatLng mEndLatlng = getIntent().getParcelableExtra("end");
        NaviLatLng mStartLatlng = getIntent().getParcelableExtra("start");
